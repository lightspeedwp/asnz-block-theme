...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--spacing-40);padding-right:var(--wp--preset--spacing--spacing-40);padding-bottom:var(--wp--preset--spacing--spacing-40);padding-left:var(--wp--preset--spacing--spacing-40)"><!-- wp:post-template -->
...
<hr class="wp-block-separator has-text-color has-border-light-color has-alpha-channel-opacity has-border-light-background-color has-background is-style-separator-thin" style="margin-top:var(--wp--preset--spacing--spacing-30);margin-bottom:var(--wp--preset--spacing--spacing-30)"/>
<!-- /wp:separator -->
