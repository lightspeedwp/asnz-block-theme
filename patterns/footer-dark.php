...
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|spacing-20"}},"textColor":"neutral-600","fontSize":"font-size-300","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-neutral-600-color has-text-color has-font-size-font-size-300"><!-- wp:paragraph -->
...
<!-- wp:separator {"align":"wide","className":"is-style-separator-thin","backgroundColor":"neutral-800"} -->
<hr class="wp-block-separator alignwide has-text-color has-neutral-800-color has-alpha-channel-opacity has-neutral-800-background-color has-background is-style-separator-thin"/>
<!-- /wp:separator -->
