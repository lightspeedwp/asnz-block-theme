...
<p class="has-main-accent-color has-text-color has-font-size-font-size-300"><?php esc_html_e( 'Easily create beautiful, fully-customizable websites with the new WordPress Site Editor and the Ollie block theme. No coding skills required. Download for free today!', 'ollie' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:social-links {"iconColor":"main","iconColorValue":"#150E29","iconBackgroundColor":"base","iconBackgroundColorValue":"#fff","className":"is-style-default","style":{"spacing":{"blockGap":{"top":"var:preset|spacing|spacing-20","left":"var:preset|spacing|spacing-20"}}},"layout":{"type":"flex","justifyContent":"left"}} -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|spacing-20"}},"textColor":"main-accent","fontSize":"font-size-300","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-main-accent-color has-text-color has-font-size-font-size-300"><!-- wp:paragraph -->
...
<div class="wp-block-group alignwide"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|spacing-20"},"elements":{"link":{"color":{"text":"var:preset|color|main-accent"}}}},"textColor":"main-accent","layout":{"type":"flex","flexWrap":"wrap","justifyContent":"space-between"}} -->
<div class="wp-block-group has-main-accent-color has-text-color has-link-color"><!-- wp:paragraph {"fontSize":"font-size-300"} -->
