...
/**
 * Title: Website CTA
 * Slug: asnz/website-cta
 * Description: Full width call to action section with centered heading, dividers, supporting text and a primary CTA button.
 * Categories: featured, text
 * Keywords: cta, call to action, enquiry, contact, banner
 * Viewport Width: 1500
 ...
 * Notes: Uses section style section-website-cta and button style button-cta with hover utility class.
 */
?>
