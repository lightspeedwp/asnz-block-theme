 ...
 * Slug: asnz/card-testimonial
 * Description:
 * Categories: asnz/card, asnz/testimonial
...
<p style="font-style:normal;font-weight:500"><?php esc_html_e( 'Alex Glacier', 'asnz-block-theme' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
