 ...
 * Slug: asnz/card-call-to-action
 * Description: 
 * Categories: asnz/card, asnz/call-to-action
...
<p class="has-base-color has-text-color"><?php esc_html_e( 'Easily create beautiful, fully-customizable websites with the new WordPress Site Editor and the Ollie block theme. No coding skills required. Anyone can do it!', 'asnz-block-theme' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button {"width":100,"className":"is-style-button-light"} -->
<div class="wp-block-button has-custom-width wp-block-button__width-100 is-style-button-light"><a class="wp-block-button__link wp-element-button" href="https://lightspeedwp.agency"><?php esc_html_e( 'Download Now', 'asnz-block-theme' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
...
<p class="has-text-align-center has-primary-accent-color has-text-color has-link-color has-x-small-font-size"><?php esc_html_e( 'or view on', 'asnz-block-theme' ); ?><a href="#"><?php esc_html_e( 'WordPress.org', 'asnz-block-theme' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
