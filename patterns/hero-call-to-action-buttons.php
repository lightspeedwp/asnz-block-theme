 ...
 * Slug: asnz/hero-call-to-action-buttons
 * Description:
...
<h2 class="wp-block-heading has-text-align-center has-secondary-font-family has-font-size-font-size-600"><?php esc_html_e( 'Design faster and publish sooner with Ollie', 'asnz-block-theme' ); ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->
