 ...
 */
?>
<!-- wp:group {"metadata":{"name":"Hero Text, Image, and Logos"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|spacing-60","bottom":"var:preset|spacing|spacing-60"},"blockGap":"var:preset|spacing|spacing-50"}},"backgroundColor":"tertiary","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull has-tertiary-background-color has-background" style="padding-top:var(--wp--preset--spacing--spacing-60);padding-bottom:var(--wp--preset--spacing--spacing-60)"><!-- wp:group {"tagName":"section","metadata":{"name":"Hero"},"align":"full","style":{"spacing":{"blockGap":"var:preset|spacing|spacing-30","margin":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained"}} -->
...
<h2 class="wp-block-heading has-text-align-center has-font-size-font-size-600"><?php esc_html_e( 'Design faster and publish sooner with Ollie', 'ollie' ); ?></h2>
<!-- /wp:heading -->
