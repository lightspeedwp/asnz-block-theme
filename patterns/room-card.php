 ...
 * Inserter: true
 * Sync: true
 * Provides: room, unit, card, listing
 * Version: 1.1.0
 * Author: Lightspeed
...
<figure class="wp-block-image size-large has-custom-border unit-image is-style-default"><img src="<?php echo esc_url( LSX_TO_URL . 'assets/img/blocks/placeholder.png' ); ?>" alt="" class="wp-image-43376" style="border-top-left-radius:8px;border-bottom-left-radius:8px;aspect-ratio:4/3;object-fit:cover"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<figure class="wp-block-image size-large is-resized"><img src="<?php echo esc_url( LSX_TO_URL . 'assets/img/blocks/unit-type.png' ); ?>" alt="" style="width:20px"/></figure>
<!-- /wp:image -->

<!-- wp:paragraph {"style":{"spacing":{"padding":{"top":"2px","bottom":"2px"}}}} -->
<p style="padding-top:2px;padding-bottom:2px"><strong><?php esc_html_e( 'Unit Type:', 'tour-operator' ); ?></strong></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<figure class="wp-block-image size-large is-resized"><img src="<?php echo esc_url( LSX_TO_URL . 'assets/img/blocks/unit-price.png' ); ?>" alt="" style="width:20px"/></figure>
<!-- /wp:image -->
